...
return [
    ...
    '/Woocommerce/Configuration/Configuration',
    '/Woocommerce/Controllers/InformationController',
    '/Woocommerce/Factories/CartFactory',
    '/Woocommerce/Factories/CategoryFactory',
